                              ...
                              <table class="min-w-full text-left text-sm font-light" >
                                ...
                                <tbody>
                                  ...
                                  <tr
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{$role[$i]}}</td>
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <a href="staffv?id={{$id[$i]}}">   <button class="flex items-center justify-center px-3 py-2 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-500 rounded-md dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50" style="display:inline-flex;">
                                            <span>View Details</span>
                               </button> </a>

                               <a href="revoke?id={{$id[$i]}}">
